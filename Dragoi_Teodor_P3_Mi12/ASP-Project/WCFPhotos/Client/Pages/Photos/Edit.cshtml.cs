...
namespace Client.Pages.Photos
{
    public class EditModel : PageModel
    {
        ...
        [BindProperty]
        public PhotoDTO EditPhotoDTO { get; set; }
        ...
        public async Task OnPostAsync(int? id)
        {
            ...
            {
                Id = id.Value,
                Location = EditPhotoDTO.Location,
                Date = EditPhotoDTO.Date,
                Event = EditPhotoDTO.Event,
                PhotoUrl = PhotoDTO.PhotoUrl
            };

            Console.WriteLine(photo.Id + ' ' + photo.Location);
